...
- **Findings:**
    ...
    - **Heat Markers:** Violet pips indicate neural density with variable opacity.
    - **Diff Windows:** `bg-[#8B5CF6]/10` and `bg-red-500/10` highlight line changes with high contrast against the `void` background.
