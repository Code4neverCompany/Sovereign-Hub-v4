...
- **Secondary Accent:** Cyan `#00FFFF` (Code, technical details, network status)
...
- **Icon Set:**
    ...
    - `.js`: Cyan code icon (`text-cyan`).
    - `.json / .yaml`: Amber data icon (`text-amber-400`).
    - `Folders`: Standard folder icon with cyan-glow on hover.
- **Micro-interactions:** 
        ...
        <div class="col-span-9 flex flex-col gap-6 overflow-hidden">
            <div class="glass-card flex-1 flex flex-col overflow-hidden">
                ...
                <div class="flex-1 grid grid-cols-2 divide-x divide-white/5 overflow-hidden">
                    <div id="editor-pane" class="bg-black/20 p-6 font-mono text-[12px] leading-relaxed text-cyan/80 overflow-y-auto focus:outline-none" contenteditable="true">
                        <!-- Raw content -->
                    </div>
            ...
            <div class="h-48 glass-card p-6 flex flex-col gap-4 overflow-hidden border-cyan/10">
                <h3 class="text-cyan/60 font-bold uppercase text-[9px] tracking-[0.3em]">Discovery_Gate // Scout_Queue</h3>
