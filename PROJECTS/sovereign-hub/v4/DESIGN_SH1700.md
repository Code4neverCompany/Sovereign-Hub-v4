...
## Date: 2026-03-05
## Theme: Lux Aesthetic 3.0 (Void / Gold / Cyan)
...
- **Card Design:** 
    ...
    - Indicator: Neon "Active" (Cyan) or "Suspended" (Dim Gold/Gray).
...
- **Cyan (#00FFFF):** Used for "System/Logic" elements, active status, and "Stable" risk.
