...
- **Secondary Accent:** Cyber Cyan (#00FFFF) - Used for system status and active uplinks.
...
<div class="glass-card glowing-border p-6 h-40 flex flex-col justify-between animate-stagger">
    <div>
        ...
        <div class="mt-3 flex items-baseline gap-2">
            ...
            <span class="text-[10px] text-cyan/60 font-mono uppercase">[UNIT]</span>
        </div>
    </div>
...
- **Interaction:** Custom tooltips with Cyber Cyan borders.
