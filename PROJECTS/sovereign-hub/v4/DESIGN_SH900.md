...
**Aesthetic:** Lux Aesthetic 3.0 (Void / Imperial Gold / Electric Cyan)
...
| **Electric Cyan** | `#00FFFF` | Active Pulses / Status Indicators / Real-time Data |
...
*   **Customization:**
    ...
    *   Node Markers: Custom CSS DivIcons with a Cyan pulse animation.
...
*   **Structure:**
    ...
    *   **Gauges:** Micro-progress bars for CPU and RAM using Cyan for fill.
