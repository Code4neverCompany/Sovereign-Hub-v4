    ...
    initCharts() {
            ...
            const gaugeOptions = {
                ...
                plotOptions: {
                    radialBar: {
                        ...
                        hollow: { size: '70%' },
                        dataLabels: {
                            name: { fontSize: '12px', color: '#D4AF37', offsetY: 120, text: 'PMF SCORE' },
                ...
                fill: { type: 'gradient', gradient: { shade: 'dark', type: 'horizontal', gradientToColors: ['#00FFFF'], stops: [0, 100] } },
        ...
        if (funnelEl) {
            const funnelOptions = {
                ...
                colors: ['#00FFFF', '#00FFFF', '#D4AF37', '#D4AF37'],
    ...
    async loadDeployments() {
        ...
        (manifests || []).forEach(m => {
            ...
            tr.innerHTML = `
                ...
                <td class="px-6 font-mono text-[10px] text-cyan/60 italic slug-target"></td>
                <td class="px-6">
