...
async function inspectSchema() {
  console.log('Inspecting todos table structure...')
  ...
  if (data && data.length > 0) {
    console.log('Sample todo and columns:', Object.keys(data[0]))
  } else {
    console.log('Todos table is empty, cannot easily infer columns via select *')
  }
}
